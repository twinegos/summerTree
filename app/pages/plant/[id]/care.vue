  ...
  <div class="min-h-screen" style="background: var(--bg);">
    ...
    <div v-else-if="plant" class="max-w-[480px] mx-auto pb-32">
      ...
      <div class="px-5 pt-8 pb-6">
        <h1 class="text-2xl font-bold tracking-tight mb-6" style="color: var(--dark);">키우는 방법</h1>
        <p class="text-sm leading-loose whitespace-pre-line" style="color: var(--dark);">{{ plant.care_guide }}</p>
      </div>
    </div>
